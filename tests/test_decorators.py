...
from aws_lambda_decorators.classes import ExceptionHandler, Parameter, SSMParameter, ValidationParameter
...
class DecoratorsTests(unittest.TestCase):  # noqa: pylint - too-many-public-methods
    ...
    def test_validate_raises_an_error_on_invalid_variables(self):
        @validate([
            ValidationParameter(func_param_name="var1", validators=[RegexValidator(r'\d+')]),
            ValidationParameter(func_param_name="var2", validators=[RegexValidator(r'\d+')])
        ])
    ...
    def test_validate_does_not_raise_an_error_on_valid_variables(self):
        @validate([
            ValidationParameter(func_param_name="var1", validators=[RegexValidator(r'\d+')]),
            ValidationParameter(func_param_name="var2", validators=[RegexValidator(r'[ab]+')])
        ])
