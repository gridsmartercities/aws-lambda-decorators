...
* [__handle_all_exceptions__](https://github.com/gridsmartercities/aws-lambda-decorators/blob/master/aws_lambda_decorators/decorators.py#L208-L228): a decorator to handle all exceptions thrown by th elambda function.
