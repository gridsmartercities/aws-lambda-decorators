...
* [__cors__](https://github.com/gridsmartercities/aws-lambda-decorators/blob/master/aws_lambda_decorators/decorators.py#L235-L288): a decorator to handle all exceptions thrown by the lambda function.
