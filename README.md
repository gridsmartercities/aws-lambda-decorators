...
* __extract_from_event__: a facade of __extract__ to extract and validate a list of variables in an AWS API Gateway lambda function _event_.
* __extract_from_context__: a facade of __extract__ to extract and validate a list of variables in an AWS API Gateway lambda function _context_.
